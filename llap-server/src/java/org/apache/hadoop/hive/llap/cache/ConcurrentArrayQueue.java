...
/**
 * the whole class is COPY and PAST from Jetty project org.eclipse.jetty.util.ConcurrentArrayQueue.
 * Reason is to avoid dependency on Jetty utils classes.
 *
...
public class ConcurrentArrayQueue<T> extends AbstractQueue<T> {
  ...
  protected static final class Block<E> {
    ...
    @SuppressWarnings("unchecked") public E peek(int index) {
